...
// Build the vehicles display html
function buildVehicleDetailDisplay($vehicleDetails, $thumbnailsDisplay){
  $dv = '<div id="vehicle-detail-display">';
  $dv .= '<div id="vehicle-gridbox">';
  $dv .= '<div id="vehicle-img-grid">';
  $dv .= $thumbnailsDisplay;
  $dv .= "<img id='prime-img' src='$vehicleDetails[imgPath]' alt='Image of $vehicleDetails[invMake] $vehicleDetails[invModel] on phpmotors.com'>";
  $dv .= '</div>';
  $dv .= '<div id="vehicle-deets">';
...
function buildVehicleThumbnailDisplay($thumbnails){
  $dv = '<h3>Vehicle Thumbnails</h3>';
  $dv .= '<div class="vehicle-thumb-display">';
